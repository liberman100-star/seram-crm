...
has(gs, /function BH13_4_archivePayloadFromCanonical_[\s\S]*?tasks: \(data\.tasks \|\| \[\]\)\.filter\(r => String\(r\['בארכיון'\][\s\S]*?loadedModules: \{ archive:true \}/, 'server archive module returns archived tasks in the archive module payload, not the active core task array');
